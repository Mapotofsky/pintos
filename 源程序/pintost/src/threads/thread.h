...
/*---------------my code---------------*/
void thread_donate_the_priority(struct thread *t);
...
void thread_remove_the_lock(struct lock* lock);
void thread_update_priority(struct thread *t);
void increase_recent_cpu();
void cal_1();
void update_recent_cpu_and_mlfqs_priority(struct thread *t, void *aux UNUSED);
void cal_2();
/*---------------my code---------------*/
